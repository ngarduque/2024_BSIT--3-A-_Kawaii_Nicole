<?php
// Define the function to generate a random order reference number
function gen_order_ref_number($length) {
...
if(isset($_GET['logout'])){
    session_destroy();
    header("location: ../index.php"); //go back to the landing page.
    die();
}
                               ...
                               <?php
                                if(isset($_GET['checkout'])){ ?>
                                    ...
                                    //generate order reference number
                                                $order_number = gen_order_ref_number(8); // Call the function to generate the order reference number
